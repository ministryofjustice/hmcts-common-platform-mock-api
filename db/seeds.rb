...
CrackedIneffectiveTrial.create(code: "S4", description: "Defendant absent - unable to proceed as Defendant not notified of place and time of hearing", reason_type: "ineffective")
CrackedIneffectiveTrial.create(code: "T", description: "Defence increased time estimate - insufficient time for trial to start", reason_type: "ineffective")
...
CrackedIneffectiveTrial.create(code: "A", description: "Prosecution end case - Prosecution discontinue case prior to trial date", reason_type: "vacated")
...
CrackedIneffectiveTrial.create(code: "Z", description: "Transfers out and errors (see page 3 of this guidance) - Only these two", reason_type: "vacated")
