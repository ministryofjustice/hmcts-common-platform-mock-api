...
RSpec.configure do |config|
  ...
  config.json_schemas[:associated_person] = 'spec/support/schemas/associatedPerson.json'
  ...
  config.json_schemas[:offence] = 'spec/support/schemas/offence.json'
  ...
  config.json_schemas[:prosecution_case] = 'spec/support/schemas/prosecutionCase.json'
