...
def create_prosecution_cases
 ...
 # create specific case with 3 random defendants plus Jammy Dodger
  ...
  case1 = FactoryBot.create(
    ...
    defendants: FactoryBot.create_list(:realistic_defendant, 2)
  )
  ...
  case2 = FactoryBot.create(
    ...
    defendants: FactoryBot.create_list(:realistic_defendant, 1)
  )
  ...
  pcases.each do |pcase|
    pcase.defendants.each do |defendant|
      ...
      if defended_item
        ...
        puts "[DESTROY][DEFENDED ITEM] no person or organisation found #{ICONS[:failure]}"
      end
    end
