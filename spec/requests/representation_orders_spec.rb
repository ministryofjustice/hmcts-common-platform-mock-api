  ...
  context "when the auth header is correct" do
    ...
    context "when the LaaReference exists" do
      ...
      it "returns an accepted status" do
        post "/prosecutionCases/representationOrder/cases/#{defendant.prosecution_case.id}/defendants/#{defendant.id}/offences/#{offence.id}", params: laa_reference_params, headers: headers
