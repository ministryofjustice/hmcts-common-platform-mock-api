...
RSpec.configure do |config|
  ...
  config.json_schemas[:court_application] = 'spec/support/schemas/global/courtApplication.json'
  ...
  config.json_schemas[:defence_organisation] = 'spec/support/schemas/global/defenceOrganisation.json'
  ...
  config.json_schemas[:respondent_counsel] = 'spec/support/schemas/global/respondentCounsel.json'
  ...
  config.json_schemas[:hearing_summary] = 'spec/support/schemas/global/search/hearingSummary.json'
